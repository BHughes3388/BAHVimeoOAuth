...
// BAHVimeoOAuth
#define COCOAPODS_POD_AVAILABLE_BAHVimeoOAuth
#define COCOAPODS_VERSION_MAJOR_BAHVimeoOAuth 0
#define COCOAPODS_VERSION_MINOR_BAHVimeoOAuth 1
#define COCOAPODS_VERSION_PATCH_BAHVimeoOAuth 0
